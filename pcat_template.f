	REAL DATA(PYTHON_NUMBER_OF_OBJECTS,100)
        REAL ARRAY1(100,100), ARRAY2(100,100), VECT1(100), VECT2(100)
        real vect3(PYTHON_NUMBER_OF_OBJECTS), vect4(PYTHON_NUMBER_OF_OBJECTS)
C
	OPEN(UNIT=21,STATUS='OLD',FILE='pcat_input.txt')
C
	N = PYTHON_NUMBER_OF_OBJECTS
	M = 100
	DO I = 1, N
...
C
  ...
  100   CONTINUE
C
 1000   FORMAT('SUMS OF SQUARES & CROSS-PRODUCTS MATRIX SECTION.')
 2000   FORMAT('COVARIANCE MATRIX SECTION.')
 3000   FORMAT('CORRELATION MATRIX SECTION.')
 4000   FORMAT('COV. MATRIX OF RANGE-NORMALIZED DATA SECTION.')
 5000   FORMAT('SPEARMAN CORRELATION MATRIX SECTION.')
 6000   FORMAT('KENDALL CORRELATION MATRIX SECTION.')
